...
filename = 'number_Plate.txt';
filepath = 'C:\Users\chait\Desktop\Vehicle number plate recognition';
file = fullfile(filepath,filename);
fid = fopen(file, 'wt');
fprintf(fid,'%s\n',final_output);
fclose(fid);
winopen('C:\Users\chait\Desktop\Vehicle number plate recognition\number_Plate.txt')